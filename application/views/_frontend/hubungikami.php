...
<main role="main">
  ...
  <div class="container marketing">
       ...
       <h1 style="text-align: center;">Hubungi Kami :</h1><br>
       <h3 style="text-align: center;">Kader Kemuning (Bu Ningsih)</h3>
       <br><img src="https://img.icons8.com/office/40/000000/whatsapp.png">
       +62 813-3494-9216
    </div>
  </div>
  <hr class="featurette-divider">
